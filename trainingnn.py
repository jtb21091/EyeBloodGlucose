...
class EyeGlucoseModel:
    ...
    def get_model_configurations(self):
        """
        Return a dictionary with the Neural Network (MLPRegressor) configuration.
        """
        return {
            "Neural Network": {
    ...
    def train_model(self):
        ...
        use_robust_scaler = False  # Set to True if needed.
        ...
        logging.info(f"\nBest Model: {best_model_name} with R² Score: {best_r2:.5f}")
